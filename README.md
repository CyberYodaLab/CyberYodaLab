...
* [📅 DAILY](https://github.com/ysec-lab/Daily) - *Scratchpad, daily operational notes, and HTML logs.*
* [📜 CHEATSHEETS](https://github.com/ysec-lab/cheatsheets) - *Automation and shell scripts.*
* [🧠 GENERAL-KNOWLEDGE](https://github.com/ysec-lab/general-knowledge) - *General readings and broad tech notes. **Tags:** `reading` `notes` `basics`*
* [📚 TECH-BOOKS](https://github.com/ysec-lab/tech-books) - *Specific technical reference materials. **Tags:** `manuals` `guides` `reference`*
* [🎓 CONTINUING-EDUCATION](https://github.com/ysec-lab/continuing-education) - *CEU tracking, certifications, and training. **Tags:** `certs` `training` `credit`*
...
* [💻 CODE-SCRIPTS](https://github.com/ysec-lab/code-scripts) - *General automation scripts. **Tags:** `bash` `python` `powershell` `automation`*
